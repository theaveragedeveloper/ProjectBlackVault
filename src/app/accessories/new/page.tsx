  ...
  return (
    <div className="min-h-full">
      <div className="flex items-center gap-4 px-6 py-4 border-b border-vault-border">
        <Link href="/accessories" className="flex items-center gap-1.5 text-vault-text-muted hover:text-vault-text text-sm transition-colors">
          <ArrowLeft className="w-4 h-4" />
          Back to Accessories
        </Link>
        <span className="text-vault-border">/</span>
        <h1 className="text-sm font-semibold text-vault-text tracking-wide uppercase">Add Accessory</h1>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <fieldset className="bg-vault-surface border border-vault-border rounded-lg p-5 space-y-4">
            ...
            <div>
              ...
              <input id="name" name="name" type="text" required placeholder="e.g. Trijicon ACOG 4x32" className={INPUT_CLASS} />
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="manufacturer" className={LABEL_CLASS}>Manufacturer <span className="text-[#E53935]">*</span></label>
                <input id="manufacturer" name="manufacturer" type="text" required placeholder="e.g. Trijicon" className={INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="model" className={LABEL_CLASS}>Model</label>
                <input id="model" name="model" type="text" placeholder="e.g. TA31RCO-M150CP" className={INPUT_CLASS} />
              </div>
            </div>
          ...
          <fieldset className="bg-vault-surface border border-vault-border rounded-lg p-5 space-y-4">
            ...
            <div>
              ...
              <textarea id="notes" name="notes" rows={3} placeholder="Any additional notes about this accessory..." className={`${INPUT_CLASS} resize-none`} />
            </div>
          </fieldset>

          {/* Actions */}
          <div className="flex items-center justify-end gap-3 pt-2">
            <Link href="/accessories" className="px-4 py-2 text-sm text-vault-text-muted hover:text-vault-text border border-vault-border rounded-md hover:border-vault-text-muted/30 transition-colors">
              Cancel
            </Link>
