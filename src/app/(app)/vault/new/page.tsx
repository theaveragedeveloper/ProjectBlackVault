        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <fieldset className="bg-vault-surface border border-vault-border rounded-lg p-5 space-y-4">
            ...
            <div>
              ...
              <input id="name" name="name" type="text" required placeholder="e.g. My Glock 19" className={INPUT_CLASS} />
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="manufacturer" className={LABEL_CLASS}>Manufacturer</label>
                <input id="manufacturer" name="manufacturer" type="text" placeholder="e.g. Glock" className={INPUT_CLASS} />
              </div>
              <div>
                <label htmlFor="model" className={LABEL_CLASS}>Model</label>
                <input id="model" name="model" type="text" placeholder="e.g. G19 Gen5" className={INPUT_CLASS} />
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className={LABEL_CLASS}>Caliber<InfoTooltip content="The internal diameter of the barrel and the cartridge the firearm is chambered for" /></label>
            ...
            <div>
              <label htmlFor="serialNumber" className={LABEL_CLASS}>Serial Number</label>
              <input id="serialNumber" name="serialNumber" type="text" placeholder="e.g. ABC123456 (optional)" className={`${INPUT_CLASS} font-mono`} />
          ...
          <fieldset className="bg-vault-surface border border-vault-border rounded-lg p-5 space-y-4">
            ...
            <div>
              ...
              <input id="acquisitionDate" name="acquisitionDate" type="date" className={INPUT_CLASS} />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input id="purchasePrice" name="purchasePrice" type="number" min="0" step="0.01" placeholder="0.00" className={`${INPUT_CLASS} pl-7`} />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 text-vault-text-faint text-sm">$</span>
                  <input id="currentValue" name="currentValue" type="number" min="0" step="0.01" placeholder="0.00" className={`${INPUT_CLASS} pl-7`} />
                </div>
              </div>
            </div>
          </fieldset>
          ...
          <fieldset className="bg-vault-surface border border-vault-border rounded-lg p-5 space-y-4">
            ...
            <div>
              ...
              <textarea id="notes" name="notes" rows={3} placeholder="Any additional notes about this firearm..." className={`${INPUT_CLASS} resize-none`} />
            </div>
          </fieldset>

          {/* Actions */}
          <div className="flex items-center justify-end gap-3 pt-2">
            <Link href="/vault" className="px-4 py-2 text-sm text-vault-text-muted hover:text-vault-text border border-vault-border rounded-md hover:border-vault-text-muted/30 transition-colors">
              Cancel
            </Link>
