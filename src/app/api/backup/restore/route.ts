        ...
        if (accessories.length) {
          await tx.accessory.createMany({
            data: accessories.map((a) => ({
              ...
              lastBatteryChangeDate:  toDate(a.batteryChangedAt ?? a.lastBatteryChangeDate),
              batteryReplacementIntervalDays: intOrNull(a.batteryIntervalDays ?? a.batteryReplacementIntervalDays),
