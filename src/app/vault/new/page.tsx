  ...
  return (
    <div className="min-h-full">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-xl font-bold text-[#E8EDF2] mb-1">New Firearm Entry</h2>
          <p className="text-sm text-[#8B9DB0]">Register a new firearm in the vault.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <fieldset className="bg-[#0E1318] border border-[#1C2530] rounded-lg p-5 space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-[#4A5A6B] mt-1">Must be unique across all firearms in vault.</p>
            </div>
          </fieldset>
