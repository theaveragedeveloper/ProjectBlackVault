    ...
    <div className="min-h-full">
      ...
      <div className="flex items-center justify-between px-6 py-5 border-b border-[#1C2530]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-widest text-[#E8EDF2] uppercase">
              Settings
            </h1>
            <p className="text-xs text-[#8B9DB0] mt-0.5">Configure your vault preferences</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          {/* ── Image Search ────────────────────────────────── */}
          <fieldset className="bg-[#0E1318] border border-[#1C2530] rounded-lg p-5 space-y-5">
            ...
            <p className="text-xs text-[#8B9DB0] leading-relaxed">
              ...
              <button
                ...
                className={`flex items-center gap-3 w-full text-left px-4 py-3 rounded-md border transition-all ${
                  enableImageSearch
                    ...
                    : "border-[#1C2530] hover:border-[#8B9DB0]/20"
                }`}
              >
                <div
                  className={`relative w-9 h-5 rounded-full transition-colors shrink-0 ${
                    enableImageSearch ? "bg-[#00C2FF]" : "bg-[#1C2530]"
                  }`}
                >
                  <div
                ...
                <div>
                  <p className="text-sm font-medium text-[#E8EDF2]">Enable Image Search</p>
                  <p className="text-xs text-[#4A5A6B] mt-0.5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-[#4A5A6B] hover:text-[#8B9DB0]"
                >
          ...
          {/* ── Status Summary ──────────────────────────────── */}
          <div className="bg-[#080B0F] border border-[#1C2530] rounded-lg p-4">
            <p className="text-[10px] uppercase tracking-widest text-[#4A5A6B] mb-3 font-mono">
...
function StatusRow({
  ...
  return (
    <div className="flex items-center justify-between">
      <span className="text-xs text-[#8B9DB0]">{label}</span>
