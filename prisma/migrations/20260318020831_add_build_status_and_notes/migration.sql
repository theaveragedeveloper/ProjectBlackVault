...
INSERT INTO "new_Build" ("createdAt", "description", "firearmId", "id", "isActive", "name", "sortOrder", "updatedAt") SELECT "createdAt", "description", "firearmId", "id", "isActive", "name", "sortOrder", "updatedAt" FROM "Build";
DROP TABLE "Build";
